 ...
 * @author congkhoa2723
 */
@WebServlet(name = "listsp", urlPatterns = {"/listsp"})
public class listsp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listsp</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet listsp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int characterCount = nhanvatDAO.getCount(); 
        //System.out.println("Số lượng nhân vật: " + characterCount);
