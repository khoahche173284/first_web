<%-- 
    Document   : products
    Created on : Feb 19, 2024, 1:11:50 PM
    Author     : congkhoa2723
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <section class="section" id="products">
            ...
            <div class="container">
               <!-- <button href="" class="right-button">mức giá tăng dần</button>-->

                <div class="row"> 
                    <%
        ArrayList<Model> modelList = (ArrayList<Model>)
                request.getAttribute("modelList");
        if (modelList != null) {
                                ...
                                <div class="hover-content">
                                    <ul>
                                        <form action="single" method = "get">
                                            ...
                                            <li><input  type="submit" value="️👁️‍️" ></a></li>
                                            <li><input type="submit" value="️⭐️‍️" ></a></li>
                                            <li><input type="submit" value="️🛒️‍️" ></a></li>
            ...
            <div class="container">
                ...
                <div class="row"> 
                    <%
                        ArrayList<Model> search = (ArrayList<Model>)
        request.getAttribute("search");
        if (search != null) {
            for (int i = 0; i < search.size(); i++) {
                Model model = search.get(i);
                    %>
